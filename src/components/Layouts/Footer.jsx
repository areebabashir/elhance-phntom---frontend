...
const Footer = () => {
  return (
<footer className="p-4 flex h-60 w-full" style={{ background: 'linear-gradient(hsla(200, 80%, 69%, 1), hsla(269, 100%, 65%, 1))' }}>
  <div className="m-auto flex flex-col md:flex-row items-center justify-between text-black space-y-4 md:space-y-0 py-8 px-8" style={{ width: '80%' }}>
